return {
    {
        ...
        opts = {
            provider_selector = function(_, ft, _)
				-- lsp folding is currently broken with ufo... getting nil instead of table in some function
                return { 'treesitter', 'indent' }
                -- INFO some filetypes only allow indent, some only LSP, some only
                -- treesitter. However, ufo only accepts two kinds as priority,
                -- therefore making this function necessary :/
                -- local lspWithOutFolding = { 'norg', 'markdown', 'bash', 'sh', 'zsh', 'css', 'html', 'python','typescriptreact', 'typescript', 'javascriptreact', 'javascript' }
